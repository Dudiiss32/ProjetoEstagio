...
Route::put('update-funcionario', [FuncionarioController::class, 'update'])->name('funcionario.update');
Route::delete('destroy-funcionario', [FuncionarioController::class, 'destroy'])->name('funcionario.destroy');
...
Route::put('update-atendimento', [AtendimentoController::class, 'update'])->name('atendimento.update');
Route::delete('destroy-atendimento', [AtendimentoController::class, 'destroy'])->name('atendimento.destroy');
...
Route::post('store-telemarketing', [TelemarketingController::class, 'store'])->name('telemarketing.store');
...
Route::put('update-telemarketing', [TelemarketingController::class, 'update'])->name('telemarketing.update');
Route::delete('destroy-telemarketing', [TelemarketingController::class, 'destroy'])->name('telemarketing.destroy');
